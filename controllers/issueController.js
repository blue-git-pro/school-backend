...
class issueController {
    ...
    async getIssues(req, res) {
        ...
        let issues = await IssueModel.find({school_id: school_id}).populate("comments", ["message", "user"]);
    ...
    async getIssue(req, res) {
        ...
        let { id } = req.params;
        let location = await IssueModel.findOne({ _id: id }).populate("comments", ["message", "user"]);
